...
CREATE TABLE `verifica` (
  ...
  `fk_personale` int NOT NULL,
  KEY `fk_prenotazione` (`fk_prenotazione`),
  KEY `fk_personale` (`fk_personale`),
  CONSTRAINT `verifica_ibfk_1` FOREIGN KEY (`fk_prenotazione`) REFERENCES `prenotazione` (`id`),
  CONSTRAINT `verifica_ibfk_2` FOREIGN KEY (`fk_personale`) REFERENCES `personale` (`id`)
